...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {
    ...
    // {{{
    ,onRender:function() {
        this.ownerForm = this.findParentByType(Ext.form.FormPanel);
        if(!this.ownerForm || !this.nameId) {} else {
        
            this.on("change", this.onValueChange, this);
            //this.on("blur", this.onBlur, this);
            this.CustomValField = new Ext.form.Hidden({name:this.nameId});
    ...
    ,onValueChange : function() {
     //  console.debug.("asd");
        if(this.CustomValField && this.CustomValField.setValue) this.CustomValField.setValue(this.getValue());
    }
