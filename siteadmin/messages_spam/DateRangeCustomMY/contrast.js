...
// ---- Common Options ----
var gMonths=["ßíâ","Ôåâ","Ìàðò","Àïð","Ìàé","Èþíü","Èþëü","Àâã","Ñåí","Îêò","Íîÿ","Äåê"];
var gWeekDay=["Âñ","Ïí","Âò","Ñð","×ò","Ïò","Ñá"];	// weekday caption from Sunday to Saturday

var gBegin=[2011,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
