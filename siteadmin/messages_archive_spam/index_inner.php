        ...
        <div class="form-in">
            ...
            <div id="slideBlock" class="slideBlock">
                ...
                <div class="form-block first">
                    <div class="b-check b-check_inline-block b-check_padright_20">
                        <input id="b-check1" class="b-check__input" name="resolve[]" type="checkbox" value="1" <?= ( in_array(1, $resolve) ? 'checked' : ''); ?>>
                        <label for="b-check1" class="b-check__label b-check__label_color_666">не спам</label>
                    </div>
                    <div class="b-check b-check_inline-block b-check_padright_20">
                        <input id="b-check3" class="b-check__input" name="resolve[]" type="checkbox" value="2" <?= ( in_array(2, $resolve) ? 'checked' : ''); ?>>
                        <label for="b-check3" class="b-check__label b-check__label_color_666">предупреждения</label>
                    </div>
                    <div class="b-check b-check_inline-block b-check_padright_20">
                        <input id="b-check2" class="b-check__input" name="resolve[]" type="checkbox" value="3" <?= ( in_array(3, $resolve) ? 'checked' : ''); ?>>
                        <label for="b-check2" class="b-check__label b-check__label_color_666">заблокированное</label>
                    </div>
                </div>
...
<tr>
    ...
    <td>
        ...
        <a href="/siteadmin/messages_archive_spam/?cmd=go&spamer=<?=$aOne['spamer_login']?>&spamer_ex=1">Жалобы на пользователя (<?= $aOne['spam_cnt']?>)</a>
        <?php } ?>
    ...
    <td class="last">
        <div class="b-layout__txt b-layout__txt_padbot_5 b-layout__txt_fontsize_11 <?= $aOne['resolve'] == 1 ? "b-layout__txt_color_6db335" : "b-layout__txt_color_c10600"; ?>">
            <?= $oSpam->resolve[$aOne['resolve']];?>
        </div>
    </td>
</tr>
<?php } ?>
...
<iframe width=132 height=142 name="gToday:contrast" id="gToday:contrast" src="/siteadmin/messages_spam/DateRangeCustomMY/ipopeng.php" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;">
</iframe>
