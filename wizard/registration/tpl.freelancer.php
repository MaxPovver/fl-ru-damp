...
<div class="b-layout">
    ...
    <div class="b-master b-master_free b-master_clear_both b-master_padbot_30">
                ...
                <div class="b-master__left">
                    <div class="b-master__right">
                        <div class="b-master__txt b-master__txt_padtop_25">
                            ...
                            <span class="b-master__icon-f b-master__icon-f_<?= $pos?>"></span><?= $step->name?>
                            <?php if(!$active && !$disable) { ?></a><?php }//if?>
                            <?php if($step->isCompleted()) { ?>
                            <span class="b-master__icon-f b-master__icon-f_ok"></span>
                            <?php }//if?>
                        </div>
                    </div>
                </div>
