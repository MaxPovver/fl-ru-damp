...
if(isset($_GET['hash']) && ($rq = sbr::getSbrCalc($_GET['hash'])) !== false) {
    ...
    $setting = array("usr_type"    => array('type' => $rq['usr_type'],
                     ...
                     "scheme_type" => array('type' => $rq['scheme_type'],
                                            'text' => $rq['scheme_type']==sbr::SCHEME_AGNT?'агентский договор':'договор подряда' 
                                   ),   
...
<input type="hidden" name="currency" id="currency" value="<?= isset($rq['currency'])?$rq['currency']: $setting['currency']['type'] ?>" /> 
	...
	<div class="b-layout b-layout_padleft_90">
		...
		<h2 class="b-layout__title">Калькулятор «Безопасной Сделки»</h2>
		<p class="b-layout__txt">С помощью калькулятора можете посчитать точные проценты и точную сумму, которую вы получите, будучи исполнителем, или выплатите в роли заказчика по «Безопасной Сделке».</p>
		<div class="b-layout__txt b-layout__txt_padtop_20 b-layout__txt_fontsize_15 b-layout__txt_bold b-layout__txt_lineheight_20">Я &mdash;
									...
									<div class="b-tooltip__top">
										...
										<div class="b-tooltip__bottom">
											<div class="b-tooltip__body b-tooltip__body_width_200">
												<div class="b-tooltip__txt">Физическое лицо – отдельные<br/> граждане любого государства,<br/> индивидуальные предприниматели,<br/> осуществляющие различные<br/> операции в разных сферах<br/> деятельности</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="b-tooltip__right">
								<div class="b-tooltip__left">
									<div class="b-tooltip__top">
										...
										<div class="b-tooltip__bottom">
											<div class="b-tooltip__body b-tooltip__body_width_200">
												<div class="b-tooltip__txt">Юридическое лицо – ООО,<br/> ОАО, ЗАО, товарищества, ОДО,<br/> кооперативы</div>
											</div>
										</div>
									</div>
								</div>
		...
		<div class="b-form b-form_padbot_40 b-form_padtop_30">
			<label class="b-form__name b-form__name_fontsize_15 b-form__name_bold b-form__name_color_6db335 b-form__name_width_200 b-form__name_padtop_1 b-form__name_relative" for="b-input__text2">Бюджет проекта</label>
			...
			<div class="b-form__txt b-form__txt_bold b-form__txt_fontsize_15 b-form__text_color_6db335 b-form__txt_padleft_10 b-form__txt_padtop_1 b-form__txt_relative">руб.</div>
			<div class="b-form__txt b-form__txt_block b-form__text_color_6db335">Эта сумма указывается при создании проекта</div>
		</div>
		
<div id="first_block">		
    <div id="emp_block">
		<div class="b-form b-form_padtop_10" id="block_calc_emp">
			<label class="b-form__name b-form__name_fontsize_15 b-form__name_bold b-form__name_padtop_3 b-form__name_width_200" for="b-input__text1" id="block_calc_emp_text">Вы заплатите</label>
			<div class="b-input b-input_inline-block b-input_width_100">
			...
			<div class="b-form b-form_bordbot_double_ccc b-form_padbot_5 b-form_padtop_20 b-form_width_440  b-filter__toggle_hide table_title">
					<div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_float_right b-form__txt_color_4d  b-form__txt_baseline">% от <div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_baseline b-form__text_color_6db335">бюджета проекта</div></div>
					<div class="b-form__txt b-form__txt_width_200 b-form__txt_fontsize_11 b-form__txt_color_4d  b-form__txt_lineheight_1 b-form__txt_baseline">Доплаты к бюджету проекта</div>
					<div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_color_4d  b-form__txt_lineheight_1 b-form__txt_baseline">Сумма, руб.</div>
			</div>
        ...
        <div class="b-form b-form_padbot_16 b-form_width_450 <?=($is_tax_com?"b-form_bordbot_f0 b-form_margbot_17":"")?>  b-filter__toggle_hide sbr_taxes" id="taxrow_<?=$sch['type'].'_'.$id?>">    
            <div class="b-form__txt b-form__txt_block ">
		        ...
		        <div class="b-form__txt b-form__txt_fontsize_13 b-form__txt_width_190 b-form__txt_valign_top b-form__txt_color_4d">
		            <?= ($is_tax_com?"Комиссия Free-lance.ru":$tax['abbr']) ?>
		        </div>
...
<div id="second_block">	
    <div id="freelancer_block">	
        <div class="b-form" id="block_calc_freelance">
			<label class="b-form__name b-form__name_bold b-form__name_fontsize_15 b-form__name_width_200 b-form__name_padtop_2" for="b-input__text3" id="block_calc_frl_text">Исполнитель получит</label>
			<div class="b-input b-input_inline-block b-input_width_100">
			...
			<div class="b-form__txt b-form__txt_bold b-form__txt_fontsize_15 b-form__txt_padtop_2 b-form__txt_padleft_10">руб. <span style="display:none" id="rating_get">и 100 баллов рейтинга</span></div>
			
			<div class="b-form b-form_bordbot_double_ccc b-form_padbot_5 b-form_padtop_20 b-form_width_440  b-filter__toggle_hide table_title">
					<div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_float_right b-form__txt_color_4d   b-form__txt_baseline">% от <div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_baseline b-form__text_color_6db335">бюджета проекта</div></div>
					<div class="b-form__txt b-form__txt_width_200 b-form__txt_fontsize_11 b-form__txt_color_4d  b-form__txt_lineheight_1 b-form__txt_baseline">Вычеты из бюджета проекта</div>
					<div class="b-form__txt b-form__txt_fontsize_11 b-form__txt_color_4d  b-form__txt_lineheight_1 b-form__txt_baseline">Сумма, руб.</div>
			</div>
...
<? } //foreach ?>
		...
		<?/*
		<h2 class="b-layout__title b-layout__title_padtop_20 b-layout__title_padbot_20">Поделитесь расчётом с работодателем</h2>
		<div class="b-form">
			<label class="b-form__name b-form__name_padtop_5 b-form__name_width_140 b-form__name_fontsize_13" for="b-input__text4">Ссылка на этот расчёт</label>
			...
			<div class="b-form__txt b-form__txt_fontsize_11 b-form__text_color_4d4d4d b-form__txt_padtop_5 b-form__txt_padleft_10 ">Скопировано в буфер обмена</div>
		</div>*/?>
		<h2 class="b-layout__title b-layout__title_padtop_35 b-layout__title_padbot_20">Поделитесь расчётом <span id="link_role">с работодателем</span></h2>
		<div class="b-form">
			<label class="b-form__name b-form__name_padtop_5 b-form__name_width_150 b-form__name_fontsize_13" for="b-input__text4">Ссылка на этот расчёт</label>
