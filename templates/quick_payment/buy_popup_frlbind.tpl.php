    ...
    <div class="b-shadow__body b-shadow__body_pad_15_20">
        ...
        <table class="b-layout__table b-layout__table_margbot_20 b-layout__table_width_full">
            <tr class="b-layout__tr">
                <td class="b-layout__td b-layout__td_padright_35 b-layout__td_padleft_20 b-layout__td_width_160">
                    <form>
                        <input type="hidden" name="id" value="" id="<?= $unic_name ?>_hidden_id" />
                        <input type="hidden" value="<?= $ammount ?>" id="<?= $unic_name ?>_ammount" disabled="disabled" />
                        <input type="hidden" name="prof_id" value="<?=$prof_use?>" />
                        <input type="hidden" name="is_spec" value="<?=(int)$is_spec?>" />
                        ...
                        <div class="b-combo b-combo_inline-block b-combo_valign_mid">
                            ...
                            <div class="b-combo__input b-combo__input_width_80 ">
                                <input id="input-weeks" name="weeks" type="text" size="80" value="0" maxlength="3" class="b-combo__input-text b-combo__input-text_center b-combo__input-text_bold">
                            </div>
                        </div>
                        <div id="frlbind_weeks" class="b-layout__txt b-layout__txt_inline-block b-layout__txt_width_60">неделя</div> 
                    </form>
                </td>
                <td class="b-layout__td">
                    <div class="b-layout__txt b-layout__txt_fontsize_11">
                        Размещение до <span id="frlbind_date" class="b-layout__bold"><?=$date_stop?></span><br>
                        <?= $profession ?><br>
