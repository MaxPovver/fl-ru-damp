...
/**
 * ≈сли создан заказ, предложен исполнителю, и в течение суток от него не было никаких действий 
...
?>
Ќапоминаем, что вчера «аказчик <?=$emp_fullname?> предложил вам заказ на услугу 
