<div class="i-shadow i-shadow_zindex_110">
    <div class="b-shadow b-shadow_inline-block b-shadow_width_950 b-shadow_vertical-center" >
        ...
        <span onclick="$('b-shadow__overlay').dispose(); return false;" class="b-shadow__icon b-shadow__icon_close"></span>
    </div>
</div>
