<div class="b-shadow__right" id="sms_is_load" data-act="<?= $action?>">
    <div class="b-shadow__left">
        <div class="b-shadow__top">
            <div class="b-shadow__bottom">
                <?php if ( !$limitIsExceed ) {?>
                <div class="b-shadow__body b-shadow__body_bg_fff b-shadow__body_pad_15">
                    <h3 class="b-shadow__title b-shadow__title_fontsize_15 b-shadow__title_bold b-shadow__title_padbot_15"><?= $sms_title ? $sms_title : "Активация телефона"?></h3>
                    ...
                    <div class="b-layout__txt b-layout__txt_fontsize_11 b-layout__txt_inline-block b-layout__txt_padleft_5">
                        ...
                        <a class="b-layout__link <?=$linkStyle ?>" href="javascript:void(0)" onclick="xajax_<?= $callback_resend ? $callback_resend : "authSMS"?>('<?=$_SESSION['uid']?>', 'resend')" id="a_sms_resend"><?=$linkText?></a>
                    </div>
                    <div class="b-buttons b-buttons_padtop_20 b-buttons_padbot_10">
                        <a href="javascript:void(0)" onclick="if(! $(this).hasClass('b-button_disabled')) { <?= ( $callback_js ? $callback_js : 'a_sms_act' ); ?>(this); }" class="b-button b-button_flat b-button_flat_green <?= $code_debug ? '' : 'b-button_disabled'?>" id="a_sms_act"><?= $sms_btn ? $sms_btn : "Активировать"?>
                ...
                <div class="b-shadow__body b-shadow__body_bg_fff b-shadow__body_pad_15">
                    <h3 class="b-shadow__title b-shadow__title_fontsize_15 b-shadow__title_bold b-shadow__title_padbot_15"><?= $sms_title ? $sms_title : "Активация телефона"?></h3>
                    <div class="b-shadow__txt b-shadow__txt_padtop_10"><?=sms_gate::LIMIT_EXCEED_LINK_TEXT?></div>
