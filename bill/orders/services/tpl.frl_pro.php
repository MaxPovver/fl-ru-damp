...
<div class="b-layout b-layout_pad_10 b-layout_bord_e6 b-layout_relative b-layout_margbot_10 service" data-name="pro_<?= $service['id']?>" data-cost="<?= round($service['ammount'])?>">
    ...
    <h3 class="b-layout__h3 b-layout__h3_padleft_70">ѕрофессиональный аккаунт  на 
                            ...
                            <div class="b-shadow__bottom">
                                ...
                                <div class="b-layout__txt b-layouyt__txt_weight_normal">
                                    <a class="b-layout__link b-layout__link_no-decorat select-auto-type" href="javascript:void(0)"
                                       ...
                                       data-cost="<?= $data['cost']?>" 
                                       data-period="<?= $data['month']?> <? if($data['day']) { ?><?= ending($data['day'], 'день', 'дн€', 'дней')?><? } elseif($data['week']) { ?><?= ending($data['week'], 'недел€', 'недели', 'недель')?><? } else { ?><?= ending($data['month'], 'мес€ц', 'мес€ца', 'мес€цев')?><? } ?>">
                                        <span class="b-layout__txt b-layout__txt_inline-block b-layout__txt_width_90 <?= $opcode == $service['op_code'] ? "b-layout__txt_color_808080" : ""?> b-layout__txt_fontsize_15 select-name">
                                            <? if($data['day']) { ?>
                                                <?= $data['day']?> <?= ending($data['day'], 'день', 'дн€', 'дн€')?>
                                            <? } elseif ($data['week']) { ?>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp; <span class="b-layout__txt b-layout__txt_fontsize_11 b-layouyt__txt_weight_normal"><a href="/payed/" class="b-layout__link">ѕодробнее об услуге</a></span>
    </h3>
    <div class="b-layout__txt b-layout__txt_fontsize_11 b-layout__txt_padbot_20 b-layout__txt_padleft_70">јккаунт PRO предоставл€ет своим обладател€м бонусы на сайте: открытые контакты, безлимитные ответы на проекты, увеличенный рейтинг, дополнительные специализации в каталоге фрилансеров, расширенные возможности в портфолио и многое другое.</div>
