...
var dNow=new Date();rd.push('&xjxr=');rd.push(dNow.getTime());delete dNow;rd.push('&u_token_key='+U_TOKEN_KEY);if(oRequest.parameters){var i=0;var iLen=oRequest.parameters.length;while(i < iLen){var oVal=oRequest.parameters[i];if('object'==typeof oVal&&null!=oVal){try{var oGuard={};oGuard.depth=0;oGuard.maxDepth=oRequest.maxObjectDepth;oGuard.size=0;oGuard.maxSize=oRequest.maxObjectSize;oVal=xt._objectToXML(oVal,oGuard);}catch(e){oVal='';}
...
//if(arguments[1] != undefined){arguments[1].parameters[arguments[1].parameters.length] = U_TOKEN_KEY; arguments[1].parameters.length += 1;}
if(1 < numArgs)
