...
//$sql = "SELECT u.uid, u.email, u.login, u.uname, u.usurname, u.subscr, usk.key AS ukey FROM users AS u LEFT JOIN users_subscribe_keys AS usk ON usk.uid = u.uid WHERE login = 'DOWNshifter'"; // TEST!!
...
<table style="margin-top: 0pt; margin-left: auto; margin-right: auto; background-color: #ffffff; text-align:left" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
        <td class="pad_null" width="20"></td>
        <td class="pad_null"><a href="<?= $eHost ?>/payed-emp?utm_source=newsletter4&utm_medium=email&utm_campaign=open_contacts_emp" target="_blank"><img src="cid:<?= $img30; ?>" width="328" height="36" border="0"></a></td>
        <td class="pad_null" width="20"></td>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
  </tr>
    <tr>
...
<table style="margin-top: 0pt; margin-left: auto; margin-right: auto; background-color: #ffffff;" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
        ...
        <td class="pad_null" bgcolor="#ffffff">
            <font color="#4d4d4d" size="1" face="tahoma,sans-serif">ѕо всем возникающим вопросам вы можете обращатьс€ в нашу <a target="_blank" style="color:#0f71c8;" href="https://feedback.free-lance.ru?utm_source=newsletter4&utm_medium=email&utm_campaign=open_contacts_emp">службу поддержки</a>.<br>
¬ы можете отключить уведомлени€ на <a target="_blank" style="color:#0f71c8;" href="<?= $eHost ?>/unsubscribe?ukey=%%%UNSUBSCRIBE_KEY%%%&utm_source=newsletter4&utm_medium=email&utm_campaign=open_contacts_emp">этой странице</a>.</font>
        </td>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
        <td class="pad_null" bgcolor="#ffffff" width="20"></td>
  </tr>
