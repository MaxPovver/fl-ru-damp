...
<form action="." method="post" name="frm" id="frm" enctype="multipart/form-data" onsubmit="return specificExt(this['logo'].value, grafExt);">

                 <table cellspacing="0" cellpadding="0" class="inform-setup"  style="width:100%; border:0">
                <tr><td colspan="3" style="height:10px"></td></tr>
                <?php if ($error) { ?>
                <tr><td colspan="3"><?= view_error($error); ?></td></tr>
                <?php } ?>
                <?php if ($info) { ?>
                <tr><td colspan="3">
                <?= view_info($info); ?>
                ...
                <tr>
                    ...
                    <input type="text" autocomplete="off" name="compname" value="<?= stripslashes($user->compname) ?>" maxlength="64" class="b-combo__input-text" />
                          </div>
                       </div>
                    </td>
                    <td>&nbsp;</td>
                ...
                <?php if ($alert[11]) { ?>
                <tr><td>&nbsp;</td><td colspan="2"><?= view_error($alert[11]) ?></td></tr>
                <?php }//if ?>
                ...
                <? if ($alert[41]) { ?>
                <tr id="em_site_1"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[41]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[42]) { ?>
                <tr id="em_site_2"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[42]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[43]) { ?>
                <tr id="em_site_3"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[43]) ?></td></tr>
                <? } ?>
                <!-- more site -->
                ...
                <? if ($alert[2]) { ?>
                <tr><td>&nbsp;</td><td colspan="2"><?= view_error($alert[2]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[31]) { ?>
                <tr id="em_icq_1"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[31]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[32]) { ?>
                <tr id="em_icq_2"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[32]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[33]) { ?>
                <tr id="em_icq_3"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[33]) ?></td></tr>
                <? } ?>
                <!-- more icq -->
                ...
                <? if ($alert['jabber']) { ?>
                <tr><td>&nbsp;</td><td colspan="2"><?= view_error($alert['jabber']) ?></td></tr>
                <? } ?>
                <!-- more jabber -->
                ...
                <? if ($alert[51]) { ?>
                <tr id="em_jabber_1"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[51]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[52]) { ?>
                <tr id="em_jabber_2"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[52]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[53]) { ?>
                <tr id="em_jabber_3"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[53]) ?></td></tr>
                <? } ?>
                <!-- more jabber -->
                ...
                <? if ($alert[3]) { ?>
                <tr><td>&nbsp;</td><td colspan="2"><?= view_error($alert[3]) ?></td></tr>
                <? } ?>
                <!-- more phone -->
                ...
                <? if ($alert[61]) { ?>
                <tr id="em_phone_1"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[61]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[62]) { ?>
                <tr id="em_phone_2"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[62]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[63]) { ?>
                <tr id="em_phone_3"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[63]) ?></td></tr>
                <? } ?>
                <!-- more phone -->
                ...
                <? if ($alert[12]) { ?>
                <tr><td>&nbsp;</td><td colspan="2"><?= view_error($alert[12]) ?></td></tr>
                <? } ?>
                <!-- more lj -->
                ...
                <? if ($alert[71]) { ?>
                <tr id="em_lj_1"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[71]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[72]) { ?>
                <tr id="em_lj_2"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[72]) ?></td></tr>
                <? } ?>
                ...
                <? if ($alert[73]) { ?>
                <tr id="em_lj_3"><td>&nbsp;</td><td colspan="2"><?= view_error($alert[73]) ?></td></tr>
                <? } ?>
                <!-- more lj -->
...
<tr>
	<td class="brdtop" style="padding:3px 20px;">Дополнительная информация</td>
		...
		<tr>
			<td>
                            <div class="b-textarea"><textarea cols="89" rows="8" name="companytxt"  rel="500" class="b-textarea__textarea tawl" placeholder="<?=(($_POST['companytxt'] != "")?antispam(htmlspecialchars(stripslashes($_POST['companytxt']))):input_ref($user->company))?>"></textarea></div>
			</td>
		</tr>
		<? if ($alert[6]) { ?>
		<tr><td><?=view_error($alert[6])?></td></tr>
		<? } ?>
		<tr>
			<td>
		...
		<tr>
			<td>
                            <div class="b-textarea"><textarea cols="89" rows="17" name="resumetxt" class="b-textarea__textarea tawl" rel="4000" placeholder="<?=(($_POST['resumetxt'] != "")?antispam(htmlspecialchars(stripslashes($_POST['resumetxt']))):input_ref($user->resume))?>"></textarea></div>
			</td>
		</tr>
		<? if ($alert[5]) { ?>
		<tr><td><?=view_error($alert[5])?></td></tr>
		<? } ?>
		<tr>
			<td>
