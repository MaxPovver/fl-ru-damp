<?php
/**
 * Шаблон попап формы быстрого редактирования комментариев к работе в дефиле
...
<input type="hidden" name="work_id" id="adm_edit_work_id" value="<?=$msg['work_id']?>">
...
<div id="adm_edit_tab_div1">
    <div class="b-form">
        ...
        <div class="b-textarea_inline-block b-textarea_width_550">
            ...
            <label class="b-check__label">Максимум 1500 символов. Можно использовать &lt;b&gt;&lt;i&gt;&lt;ul&gt;&lt;li&gt;&lt;s&gt;</label>
        </div>
