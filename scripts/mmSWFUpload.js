...
mmSWFUpload = {
	...
	init: function(settings) {
		...
		// Create SWFObject
		var so = new SWFObject("upload.swf", "_mmSWFUploadField", "1px", "1px", this.addSetting("flash_version", "8"), "#000000");
		...
		if(deconcept.SWFObjectUtil.getPlayerVersion(so.getAttribute("version")).major >= 8) {
			...
			so.addVariable("allowedFilesize", this.addSetting("allowed_filesize", "50"));
...
//			link.innerHTML = '<span class="c">Uploading...</span>';
			link.className = this.addSetting("cssClass", "btn");
	...
	handleErrors: function(errcode, file, msg) {
		...
		switch(errcode) {
			...
			case -20:	// No backend file specified
				msg = 'No backend file specified ' + msg;
				alert(errcode + ", " + file + ", " + msg);
				break;
			case -30:	// IOError
				msg = 'IOError ' + msg;
			...
			case -40:	// Security error
				msg = 'Security error ' + msg;
				alert(errcode + ", " + file + ", " + msg);
				break;

			case -50:	// Filesize too big
				msg = 'File too big ' + msg;
...
return _16;
	...
	if(navigator.plugins&&navigator.mimeTypes&&navigator.mimeTypes.length){
		...
		_19="<embed style=\"position: absolute;\"  type=\"application/x-shockwave-flash\" src=\""+this.getAttribute("swf")+"\" width=\""+this.getAttribute("width")+"\" height=\""+this.getAttribute("height")+"\"";
		...
		_19="<object style=\"position: absolute;\" id=\""+this.getAttribute("id")+"\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" width=\""+this.getAttribute("width")+"\" height=\""+this.getAttribute("height")+"\">";
