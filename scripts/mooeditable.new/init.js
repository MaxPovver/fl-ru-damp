...
function initWysiwyg() {
    ...
    var blockElems = /^(H[1-6]|HR|P|DIV|ADDRESS|PRE|FORM|TABLE|LI|OL|UL|TD|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|SCRIPT|NOSCRIPT|STYLE)$/i;
...
//                console.log(e.key);
            ...
            _rootEl = function(e, ed) {
                ...
                if (!fc || (fc && !fc.nodeName.test(blockElems) && fc.nodeName.toLowerCase() !== 'br')) {
