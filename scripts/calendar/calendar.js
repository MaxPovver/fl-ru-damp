...
var CalendarEightysix = new Class({
	...
	initialize: function(target, options) {
		...
		Locale.addEvent('change', function() { this.render(); this.pick(); }.bind(this));
	...
	renderYear: function() {
		...
		for(var i = 1; i < 13; i++) {
			...
			month.set('html', month.get('html').substr(0, 3)); //Setting and getting the innerHTML takes care of html entity problems (e.g. [M&a]uml;r => [Mдr]z)
