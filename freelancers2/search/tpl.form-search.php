    ...
    <form action="" id="main-search-form" method="get">
       <div>
        ...
        <?php if($show_all_freelancers): ?><input type="hidden" name="show" value="all" /><?php endif; ?>
                ...
                <fieldset class="search-block" style="padding: 0px; clear:both;">
                    ...
                    <table class="b-layout__table b-layout__table_width_full">
                        <tr class="b-layout__tr">
                            ...
                            <td class="b-layout__td b-layout__td_width_160 b-layout__td_valign_bot b-layout__td_padleft_10 b-layout__td_width_full_ipad b-layout__td_pad_null_ipad">
                                <button type="submit" class="b-button b-button_flat b-button_flat_orange b-button_nowrap b-button_padlr_10">
                                    Найти исполнителя
                                </button>
                            </td>
                            <?php /*
                        ...
                        <?php if(is_emp()||!get_uid(false)) { ?><a class="b-button b-button_flat b-button_flat_green b-page__ipad b-page__iphone" href="/public/?step=1&kind=1" onClick="_gaq.push(['_trackPageview', '/virtual/employer/button_project_create']); ga('send', 'pageview', '/virtual/employer/button_project_create'); yaCounter6051055reachGoal('proekt_dobavlen');">Опубликуйте проект</a><?php } ?>
